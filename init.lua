...
require('lazy').setup({
  ...
  { -- Autoformat
    ...
    opts = {
      ...
      format_on_save = function(bufnr)
        local disable_filetypes = { c = true, cpp = true, tex = true, markdown = true, mail = true }
        return {
          timeout_ms = 500,
  ...
  { -- Highlight, edit, and navigate code
    ...
    -- build = ':TSUpdate',
    opts = {
      ensure_installed = { 'c', 'cpp', 'go', 'lua', 'python', 'markdown', 'markdown_inline', 'tsx', 'javascript', 'typescript', 'vimdoc', 'vim', 'bash' },
